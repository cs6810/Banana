	...
	<div>
		<c:forEach items="${buyList}" var="buylistVO">
		 <div class="card" style="width: 18rem;">
		  <img id="img1" src="images/product/${buylistVO.image1}" class="card-img-top" alt="물건사진">
		  <div class="card-body">
		    <h5 class="card-title">${buylistVO.product_name}</h5>
		    <p class="card-text">${buylistVO.content}</p>
