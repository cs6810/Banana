...
<body>
  <article>
    ...
    <form id="join" action="join" method="post" name="formm">
        ...
        <p>가입에 필요한 정보를 입력하시고 [가입하기] 버튼을 눌러주세요</p>
        <label>E-mail (ID)</label>
       <input type="text"      name="email_id"  id="email_id"  value="${email_id}"   size="20"  >
        ...
        <label>비밀번호 확인</label> 
        <input type="password"  name="pwdCheck" id="pwdCheck" size="20"><br> 
        <label>성명</label>
        <input type="text" name="name" id="name" size="20"><br> 
        <label>닉네임</label>
         <input type="text" name="nk_name" id="nk_name" size="20"><br> 
          <label>전화번호</label> 
        <input  type="text"     name="ph_nm" size="20"><br>
        ...
        <!-- 
        <label for="zip_num">주소</label>
        <input type="text" name=" zip_num" id="zip_num" placeholder="우편번호">
        <input type="button" id="find_button" value="주소 찾기"><br>
        
        <input type="text" name="road" id="road" placeholder="도로명주소">
        <input type="text" name="land" id="land" placeholder="지번주소"> <br>
